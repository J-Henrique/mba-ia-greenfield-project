...
import { CreateVideos1788123805882 } from './migrations/1788123805882-CreateVideos';
...
describe('Database migrations (integration)', () => {
  ...
  it('should revert the last migration and remove videos table', async () => {
    ...
    expect(result.map((r) => r.table_name)).not.toContain('videos');
  });
});
